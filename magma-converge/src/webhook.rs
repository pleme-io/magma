...
///
/// The BackendError trait impl is auto-generated by
/// `#[derive(BackendError)]` from per-variant attributes.
...
#[backend_error(trait_path = "crate::backend_error::BackendError")]

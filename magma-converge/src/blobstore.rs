...
///
/// The BackendError trait impl (is_retryable / is_auth_failure / kind)
/// is auto-generated by `#[derive(BackendError)]` from per-variant
/// attributes. `kind()` delegates to `.discriminant()` (auto-generated
/// by `#[derive(Discriminant)]`).
